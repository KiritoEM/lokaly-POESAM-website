...
const LandingContact = (): JSX.Element => {
    return (
        <div className="container mx-auto">
            <section className="landing__contact bg-[url('/contact-bg.svg')] pb-20 px-10 lg:pl-36 lg:pr-40 w-full bg-cover bg-no-repeat bg-bottom flex items-end gap-10">
                <div className="contact-header w-3/5 flex flex-col gap-3 mb-20">
                    <h2 className="text-4xl text-blue01 calSans">Prenez contact avec nous</h2>
                    <p className="text-blue02 text-lg">Vous avez quelque chose à ajouter? Un partenariat à discuter? ou quelque chose à faire passer?
